...
public class SQLtoJSON_Java {       
    ...
    public static void main(String[] args) {
		...
		String currentDir = new File("").getAbsolutePath();		
                String database = currentDir + "/Reservation.db";
		...
		FileWriter file = new FileWriter(currentDir + "/passenger_NoSQL.json");
		file.write(prettyJsonString);
		file.flush();
		file.close();
	
                System.out.println("Successfully Migrated Data model from SQL database data to JSON.");
